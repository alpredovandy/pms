...
<body class="layout-3">
                    ...
                    <div class="card profile-widget">
                      <div class="profile-widget-header">
                        ...
                        <div class="profile-widget-items">
                          ...
                          <div class="profile-widget-item">
                            <div class="profile-widget-item-label">Rawat Inap</div>
                      ...
                      <div class="profile-widget-description">
                        <div class="profile-widget-name">Ujang Maman <div class="text-muted d-inline font-weight-normal"><div class="slash"></div> Perawat RS A</div></div>
                        <div class="list-group">
                                <a href="#" class="list-group-item list-group-item-action">
                                  Nama : Ujang
                                </a>
                                <a href="#" class="list-group-item list-group-item-action">Emai : mahrus@pcr.ac.id</a>
                                <a href="#" class="list-group-item list-group-item-action">No HP :08123098</a>
                                <a href="#" class="list-group-item list-group-item-action">Jenis Kelamin :</a>
                              </div>
                      </div>
                                  ...
                                  <article class="article">
                                    <div class="article-header">
                                      ...
                                      <div class="article-title">
                                        <h2><a href="#">Nama Kamar No 124</a></h2>
                                      </div>
                                    </div>
  ...
  <script src="assets/js/Healty Monitoring System.js"></script>
