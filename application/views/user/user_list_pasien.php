  ...
  <div class="main-content">
        <section class="section">
          <div class="section-header">
            ...
            <a href="<?php echo site_url('user/create_pasien'); ?>" class="btn btn-primary text-right">Tambah Data</a>
              </div>
          </div>
          <table class="table table-hover table-resposive table-condensed">
            ...
            <?php
              ...
              <tr>
                ...
                <td>Aktif</td>
                <td><?php echo $value->nama_keluarga; ?></td>
                <td class="btext-white"><a href="<?php echo site_url('user/update_pasien/'.$value->id_user."/".$role); ?>" class="btn btn-icon btn-warning"><i class="far fa-edit"></i></a> <a href="<?php echo site_url('user/delete/'.$value->id_user."/".$role); ?>" class="btn btn-icon btn-danger"><i class="fas fa-trash"></i></a></td>
            </tr>
                <?php } ?>
            </tbody>
          </table>   
