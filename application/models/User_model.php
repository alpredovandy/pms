...
class User_model extends CI_Model
{
    ...
    // datatables
    function json() {
        $this->datatables->select('id_user,nama,no_hp,email,jk,username,password,foto,nama_keluarga,alamat_keluarga,email_keluarga,no_hp_keluarga,role');
	...
	$this->db->or_like('nama_keluarga', $q);
	$this->db->or_like('alamat_keluarga', $q);
	$this->db->or_like('email_keluarga', $q);
	$this->db->or_like('no_hp_keluarga', $q);
